...
export const MenuNode: React.FC<MenuNodeProps> = props => {
    ...
    if (props.mode === 'popuover') {
        cls.push(`${CLASSNAME}-menu-popuover`);
    }
    ...
    const currentInlineIndentValue = isNaN(props.inlineIndent) ? 14 : props.inlineIndent;
    ...
    const getStyle = (type: string) => {
        ...
        if (props.mode === 'popuover') {
            ...
            const paddingLeft = (currentLevel + 1) * currentInlineIndentValue;
            if (type === 'group') {
