...
export const columns = ({
    ...
    const plugin: Plugin = new Plugin({
        ...
        props: {
            nodeViews: {
                columns: (node: Node, view: EditorView, getPos: () => number) => new ColumnsView(node, view, getPos),
                column: (node: Node, view: EditorView, getPos: () => number) => new ColumnView(node, view, getPos)
            } as any,
            // const onMouseMove = (e) => {
