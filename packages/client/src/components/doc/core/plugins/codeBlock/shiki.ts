...
//   'wl', 'wolfram', 'xml', 'xsl', 'yaml', 'yml', 'zenscript', 'zig', 'zsh', '文言'
// ]
  langs: ['javascript', 'typescript', 'jsx', 'tsx', 'css', 'scss', 'sass', 'python', 'json', 'css', 'html', 'java', 'c', 'cpp', 'go', 'ruby', 'php', 'rust', 'kotlin', 'swift', 'bash', 'yaml', 'markdown'],
});
...
// 如果需要动态加载新语言：
// async function changeLangAndEnsureLoaded(view, lang) {
...
// const setLanguage = (view, pos, lang) => {
//   view.dispatch(
